      ...
      <div>
        <div className="bg-secondary-800 text-white flex flex-col gap-10 p-10 sm:h-full sm:w-[50vw]">
          ...
          <div className="sm:text-2xl">
            <p>Elyas Fontoura, 20 anos, conossoir de negócios e criador do Método Fontoura™,  uma sequência de ativações que promete transformar qualquer um em alguém — desde que saiba escutar (e pagar).</p>
            <br />
